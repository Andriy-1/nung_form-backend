...
const SQL = {
	...
	create: `INSERT INTO status (name) values ($1) RETURNING *`,
	remove: `DELETE FROM status WHERE id = $1 RETURNING *`,
}
...
export const remove = async (req, res) => {
	try {
		...
		if (isDel) {
			...
			return res.json({
				success: true,
				message: `Навчальний ступінь ${delData.name} видалено з таблиці`,
