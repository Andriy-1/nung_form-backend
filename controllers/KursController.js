...
const SQL = {
	getAll: `SELECT * FROM kurs`,
	create: `INSERT INTO kurs (name) values ($1) RETURNING *`,
	remove: `DELETE FROM kurs WHERE id = $1 RETURNING *`,
}
...
export const remove = async (req, res) => {
	try {
		...
		if (isDel) {
			...
			return res.json({
				success: true,
				message: `${delData.name} видалено з таблиці`,
